...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            var lastValue = stringResource(id = R.string.label_value)
            var date = stringResource(id = R.string.label_date)
                    ...
                    try {
                        ...
                        if (response.isSuccessful) {
                            ...
                            if (lastValueDouble != null) {
                                ...
                                lastValue =
                                    numberFormat.format(lastValueDouble) // Atualiza o estado
                            }
                        ...
                        Toast.makeText(context, "Falha na chamada: ${e.message}", Toast.LENGTH_LONG)
                            .show()
                    }
                }
                }
